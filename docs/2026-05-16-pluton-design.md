...
- **M7.5b: Textures & UV**. UV mapping, texture assets, texture sampling in the shader, the OBJ `.mtl`/`vt` round-trip (`#80`), and thumbnails in the `.pluton` container (`#78`). The textures half of the roadmap's original single M7.5 entry.
